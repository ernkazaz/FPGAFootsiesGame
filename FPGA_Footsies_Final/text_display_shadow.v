module text_display_shadow (
    ...
    parameter [9:0] TEXT_LENGTH = 10'd11; // "SHADOWBLOCK" = 11 characters
    
    // Screen center calculations (positioned in middle but higher up)
    ...
    parameter [9:0] START_Y = (SCREEN_HEIGHT / 2) - 10'd80;    // Higher up to make room for "Single Player"
    
    // Colors
    parameter [7:0] TEXT_COLOR = 8'b00000000;  // Black text (RRRGGGBB)
    ...
    wire [3:0] char_index = char_x / CHAR_WIDTH;  // Which character (0-10)
    ...
    always @(*) begin
        case (char_index)
            ...
            4'd3: begin // 'D'
                case (pixel_in_char_y[3:0])
                    4'd0:  char_data = 8'b11111000;
                    4'd1:  char_data = 8'b11001100;
                    4'd2:  char_data = 8'b11000110;
                    4'd3:  char_data = 8'b11000110;
                    4'd4:  char_data = 8'b11000110;
                    4'd5:  char_data = 8'b11000110;
                    4'd6:  char_data = 8'b11001100;
                    4'd7:  char_data = 8'b11111000;
                    default: char_data = 8'b00000000;
                endcase
            end
            4'd4: begin // 'O'
            ...
            4'd10: begin // 'K'
                case (pixel_in_char_y[3:0])
                    4'd0:  char_data = 8'b11000110;
                    4'd1:  char_data = 8'b11001100;
                    4'd2:  char_data = 8'b11011000;
                    4'd3:  char_data = 8'b11110000;
