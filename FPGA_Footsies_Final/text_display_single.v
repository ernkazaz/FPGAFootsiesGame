module text_display_single (
    input wire clock,
    input wire reset,
    input wire [9:0] pixel_x,
    input wire [9:0] pixel_y,
    input wire [7:0] bg_color,    // Background color from shadow module
    ...
    parameter [9:0] START_Y = (SCREEN_HEIGHT / 2) + 10'd40;    // Below center, under SHADOWBLOCK
