...
module Collision_logic (
    ...
    wire hit_normal = attacker_hitbox_active && target_hurtbox_active &&
                            (attacker_attack_flag || attacker_diratk_flag) && x_overlap_normal && y_overlap_normal;

    wire hit_recovery = attacker_hitbox_active && target_recovery_hurtbox_active &&
                            (attacker_attack_flag || attacker_diratk_flag) && x_overlap_recovery && y_overlap_recovery;
