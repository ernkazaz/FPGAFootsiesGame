...
module Sprite_FSM (
    ...
    localparam ATTACK_START_FRAMES = 6'd5;
    localparam ATTACK_ACTIVE_FRAMES = 6'd2;
    localparam ATTACK_RECOVERY_FRAMES = 6'd16;

    localparam DIRATK_START_FRAMES  = 6'd4;
    localparam DIRATK_ACTIVE_FRAMES = 6'd3;
    localparam DIRATK_RECOVERY_FRAMES = 6'd15;

    localparam HITSTUN_OFFSET = 6'd1;
    localparam BLOCKSTUN_OFFSET = 6'd3;
